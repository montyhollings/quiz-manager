                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control{{ $errors->has('question') ?? ' is-invalid' ?? '' }}" {{$view ? 'readonly' : ''}} type="text" id="question" name="question" placeholder="Question" value="{{ old('question') ?? $Question->question ?? null }}" required />
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select name="number_of_answers" id="number_of_answers" class="custom-select " required {{$view ? 'disabled' : ''}}>
                            ...
                            <div class="col-6">
                                @if(Auth::user()->can_edit)
                                    <div class="form-group">
                                        ...
                                        <select name="correct_select" id="correct_select" class="custom-select" required {{$view ? 'disabled' : ''}}>
                                ...
                                <div class="row">
                                    <div class="col-3 question-col-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="answer_1" name="answer_1" {{$view ? 'readonly' : ''}} @if(old('answer_1')) value="{{old('answer_1')}}" @elseif($Question && $Question->answers->first()->answer) value="{{$Question->answers->first()->answer}}" @endif required >
                                    ...
                                    <div class="col-3 question-col-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="answer_2" name="answer_2" {{$view ? 'readonly' : ''}} @if(old('answer_2')) value="{{old('answer_2')}}" @elseif($Question && $Question->answers->get(1)->answer) value="{{$Question->answers->get(1)->answer}}" @endif required>
                                    ...
                                    <div class="col-3 question-col-3 @if(!$Question) d-none @elseif($Question->answers->count() < 3)  d-none @endif"  >
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="answer_3" name="answer_3" {{$view ? 'readonly' : ''}} @if(old('answer_3')) value="{{old('answer_3')}}" @elseif($Question && $Question->answers->count() >=3 &&$Question->answers->get(2)->answer) value="{{$Question->answers->get(2)->answer}}" @endif>
                                    ...
                                    <div class="col-3 question-col-4 @if(!$Question) d-none @elseif($Question->answers->count() < 4)  d-none @endif" >
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="answer_4" name="answer_4" {{$view ? 'readonly' : ''}} @if(old('answer_3')) value="{{old('answer_3')}}" @elseif($Question && $Question->answers->count() >=4 &&$Question->answers->get(3)->answer) value="{{$Question->answers->get(3)->answer}}" @endif >
